      ...
      <div className={styles.addProductCartel}>
        <form onSubmit={handleSubmit}>
          ...
          <div className={classNames(productType === 'product' ? styles.hidePrice : null)}>
            ...
            <div>
              <input type="number" max='10000' value={productPriceOne} onChange={handleProductPriceOneChange} />
              <input type="number" max='10000' value={productPriceTwo} onChange={handleProductPriceTwoChange} />
              <input type="number" max='10000' value={productPriceThree} onChange={handleProductPriceThreeChange} />
            </div>
          </div>
          <div>
